...
namespace InstagramMVC.Controllers
{
    ...
    public class PublicationController : Controller
    {
        ...
        public async Task<IActionResult> LikeUnlike(int? id)
        {
            ...
            Publication? publication = await _context.Publications.Include(p => p.User).Include(p => p.Likes).FirstOrDefaultAsync(p => p.Id == id);
        ...
        public async Task<IActionResult> EditDescription(int? id, string? description)
        {
            ...
            Publication? publication = await _context.Publications.FindAsync(id.ToString());
            if (publication == null)
            {
                return NotFound();
            }
